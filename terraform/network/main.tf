...
resource "aws_route_table_association" "pri-sub-4-with-Pri-rt-b" {
  subnet_id         = var.pri_sub_4_id
  route_table_id    = aws_route_table.pri-rt-a.id
}
...
## associate private subnet pri-sub-4 to private route table b
